    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/profile.png') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
               ...
               @can('the bill')
                <li class="side-item side-item-category">The bill</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">THE BILLS</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                    @can('list bill')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'bills')) }}">List Bills</a></li>

                        @endcan

                        @can('paid bils')
                            <li><a class="slide-item" href="{{ url('bill_Paid') }}">Paid Bills</a></li>
                            @endcan
                            @can('unpaid bills')
<li><a class="slide-item" href="{{ url('bill_unPaid') }}">Unpaid Bills</a></li>
@endcan
@can('partially bills')
<li><a class="slide-item" href="{{ url('bill_Partial') }}">Partially Paid Bill</a></li>
@endcan                    
                            @can('bill archive')
                        
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Archive')) }}">Bill Archive</a></li>
                        @endcan
                    </ul>
                </li>
         @endcan
             @can('reports')
                ...
                <li class="slide">
                    ...
                    @can('customer reports')
                            ...
                            @can('billing reports<')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}"
           ...
           @can('users')
                ...
                <li class="slide">
                    ...
                    @can('section')
                            ...
                            @endcan
                            @can('products')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'prodacts')) }}">Products</a></li>
                            @endcan
                    </ul>
                </li>
               @endcan
