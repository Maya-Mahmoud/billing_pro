...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">bills</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ unpaid bills
    ...
    @if (session()->has('delete_bill'))
        <script>
            window.onload = function() {
                notif({
                    msg: "The bill has been successfully deleted",
                    type: "success"
                })
            }
...
Payment status updated successfully",
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="bills/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp;  add bill</a>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href=" {{ url('edit_bill') }}/{{ $bill->id }}">edit bill
                                                       </a>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ URL::route('Status_show', [$bill->id]) }}"><i
                                                            class=" text-success fas
                                                                                                                                fa-money-bill"></i>&nbsp;&nbsp;change payyment status </a>
    ...
    <div class="modal fade" id="Transfer_bill" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Archiving the bill</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    <form action="{{ route('bills.destroy', 'test') }}" method="post">
