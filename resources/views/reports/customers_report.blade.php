...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Repot</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ coustomers_report
                </span>
        </div>
    </div>
</div>
                ...
                <form action="/Search_customers" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label for="inputName" class="control-label">prodacts</label>
                            ...
                            <tbody>
                                ...
                                @foreach ($bills as $bill)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $bill->product }}</td>
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $bill->id }}">{{ $bill->section->section_name }}</a>
                                        </td>
                                        <td>{{ $bill->Discount }}</td>
                                        <td>{{ $bill->Rate_VAT }}</td>
